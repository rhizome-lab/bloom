...
use bloom_core::{Capability, EntityId, WorldStorage};
...
impl KernelOps {
    ...
    ) -> Result<Option<Capability>, bloom_core::StorageError> {
    ...
    pub fn has_capability(
        ...
        cap_type: &str,
        filter: Option<serde_json::Value>,
    ) -> Result<bool, bloom_core::StorageError> {
    ...
    ) -> Result<(), bloom_core::StorageError> {
        let storage = self.storage.lock().unwrap();
