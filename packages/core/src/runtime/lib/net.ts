...
export const netHttpGet = defineOpcode<[Capability | null, string], Promise<string>>(
  "net.http.get",
  {
    metadata: {
      label: "HTTP GET",
...
export const netHttpPost = defineOpcode<[Capability | null, string, string], Promise<string>>(
  "net.http.post",
  {
    metadata: {
      label: "HTTP POST",
