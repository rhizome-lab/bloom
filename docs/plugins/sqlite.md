...
Provides capability-based access to SQLite databases for viwo entities.
...
The plugin is automatically loaded by the viwo server. No additional configuration is required.
