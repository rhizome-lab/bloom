...
- **Write in TypeScript**: Write BloomScript as standard TypeScript functions (e.g. in `verbs.ts`). The transpiler converts this to BloomScript. Do not write raw JSON S-expressions manually.
